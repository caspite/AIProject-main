...
public class Tile {
    ...
    protected void expand(Position previousPosition) {
        ...
        for(int i = 0 ; i < operators.length ; i++) { //Start loop over the operators.
            ...
            if(operators[i] != 0) { // If the operator is available;
                ...
                if(pos!=null){
                    if(checkMatrixForMatrix(position.getState(),pos.getState())){
    ...
    public void setbNb(BranchAndBound bNb){this.bNb=bNb;}
    ...
    public void setAlgoritmType(int algoritmType) {
    ...
    public void increaseAtomicCounter(){
            if(bNb!=null){
                bNb.increaseAtomicCounter();
            }
            if(aStar!=null){
                aStar.increaseAtomicCounter();
            }
